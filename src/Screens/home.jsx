...
export const ProductServices = () => {
	let type = [
		...
		},
		{
			...
			description: `Bhumble Global Enterprises is your go-to source for various examination scratch cards, including those for Waec, Neco, and Nabteb. We take pride in providing top-quality service and aim to make our website your go-to destination after your first experience with us. Our priority is your satisfaction.`,
		},
		{
	...
	return (
		<div className="py-5">
			<section className="py-5">
				...
				<div className="d-flex justify-content-center">
					<p className="text-center w-50 w50 fontReduce">
						With Bhumble Global Enterprises, You will enjoy a fast data delivery
...
export const StandToGain = () => {
	let type = [
		...
		// },
		{
			...
			description: `Periodically, Bhumble Global Enterprises offers the best discounts and special deals on all of our services, including data, airtime, and cable subscriptions. Stay tuned for updates on our special offers and take advantage of the opportunity to save on these services.`,
		},
		// {
