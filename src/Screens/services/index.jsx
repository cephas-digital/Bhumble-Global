				...
				<div className="d-grid py-5 blogGrid">
					<div className="py-5 d-flex flex-column" data-aos="fade-right">
						...
						<p
							...
							Yes, we got you covered, With Bhumble Global Enterprises Enjoy a
							easy and fast data delivery with Optimal security and also enjoy
							the best offers and discount sales on all our products
							periodically.
						</p>
					</div>
					<img
